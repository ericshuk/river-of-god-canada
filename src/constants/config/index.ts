...
export const SITE_CONFIG = {
  author: 'Eric Amshukov',
  backgroundColor: '#FFF',
  description:
    'River of God Canada Church is a non-denominational Christian Ministry',
  name: 'River of God Canada',
  shortName: 'RoG Canada',
  themeColor: '#FFF',
} as const;

/** Site icons generated using https://www.pwabuilder.com/imageGenerator. */
export const SITE_ICONS: MetadataRoute.Manifest['icons'] = [
  {
